			...
			geocoder.geocode({
				...
				if (status === google.maps.GeocoderStatus.OK)
				{
					...
					var delivery_marker = new google.maps.Marker({
						...
						url: 'http://maps.google.com?key=AIzaSyDHrgdkxq_I1mabWANBfNBuT8vaJkR_Zik&q={$addresses.delivery->address1|urlencode},{$addresses.delivery->postcode|urlencode},{$addresses.delivery->city|urlencode}{if ($addresses.delivery->id_state)},{$addresses.deliveryState->name|urlencode}{/if},{$addresses.delivery->country|urlencode}'
					});
