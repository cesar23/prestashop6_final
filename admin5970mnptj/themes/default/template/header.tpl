		...
		<nav id="header_infos" role="navigation">
			<div class="navbar-header">
				...
				<a id="header_shopversion" href="{$default_tab_link|escape:'html':'UTF-8'}">
					<span id="shop_version" style="margin: 0px 0px 0px 38px;">{$version}</span>
				</a>
				{* Shop *}
...
{/if}
				<ul id="header_employee_box">
					...
					<li class="hidden-sm hidden-xs">
						...
						*}
						<li class="hidden-sm hidden-xs">
						<a href="http://solucionessystem.com/" target="_blankk" class="addons_connect toolbar_btn">
								<i class="icon-chain-broken"></i>
								<span class="string-long">{l s='ir a la pagina del Creador'}</span>								
							</a>
							</li>
