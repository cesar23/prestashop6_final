...
class StoresControllerCore extends FrontController
{
    ...
    public function setMedia()
    {
        ...
        if (!Configuration::get('PS_STORES_SIMPLIFIED')) {
            ...
            $this->addJS('http'.((Configuration::get('PS_SSL_ENABLED') && Configuration::get('PS_SSL_ENABLED_EVERYWHERE')) ? 's' : '').'://maps.google.com/maps/api/js?sensor=true&key=AIzaSyDHrgdkxq_I1mabWANBfNBuT8vaJkR_Zik&region='.substr($default_country->iso_code, 0, 2));
