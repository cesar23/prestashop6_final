...
function createMarker(latlng, name, address, other, id_store, has_store_picture)
{
	...
	var html = '<b>'+name+'</b><br/>'+address+(has_store_picture === 1 ? '<br /><br /><img src="'+img_store_dir+parseInt(id_store)+'.jpg" alt="" />' : '')+other+'<br /><a href="http://maps.google.com/maps?saddr=&key=AIzaSyDHrgdkxq_I1mabWANBfNBuT8vaJkR_Zik&daddr='+latlng+'" target="_blank">'+translation_5+'<\/a>';
