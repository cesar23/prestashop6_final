...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row">
		...
		<div class="pb-right-column col-xs-12 col-sm-4 col-md-3">
			...
			{if $smarty.const._SOLUSYSTEM_WEB_THEME_ADD_CART==1}
			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
			{else}
			<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$smarty.const._PS_BASE_URL_|cat:$smarty.const.__PS_BASE_URI__|cat:"contactanos"}" method="post">
			{/if}
				...
				<div class="box-info-product">
					...
					<!--ocultamos el boton añadir al carro -->
					{if $smarty.const._SOLUSYSTEM_WEB_THEME_ADD_CART==1}
