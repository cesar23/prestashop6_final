...
{else}
	...
	<section class="bottom-footer col-xs-12">
		<div>
			{l s='[1] %3$s %2$s - Systema implementado %1$s [/1]' mod='blockcms' sprintf=['solucionessystem.com', 'Y'|date, '©'] tags=['<a class="_blank" href="http://www.solucionessystem.com">'] nocache}
		</div>
	</section>
	{/if}
	<!-- /Block CMS module footer -->
