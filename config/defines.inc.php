...
/*----definiciones admin cesar----*/
/* -- USO --
$smarty.const._SOLUSYSTEM_WEB_THEME_=='senorpeluche'
*/
define('_SOLUSYSTEM_WEB_THEME_', 'senorpeluche');
define('_SOLUSYSTEM_WEB_THEME_ADD_CART', 0);//1 muestra carrito cuando estas desntro del producto
define('_SOLUSYSTEM_WEB_THEME_ADD_CART_LIST', 0);//1 muestra carrito en el listado
define('_SOLUSYSTEM_WEB_', 'solucionessystem.com');
